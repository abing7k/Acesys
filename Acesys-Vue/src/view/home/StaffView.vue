  ...
  <tr>
    <td height="15" align="left" valign="top">&nbsp;</td>
      <td height="15" align="left" valign="top" class="12"><table width="100%"  border="0" cellspacing="0" cellpadding="1">
        ...
        <tr bgcolor="#E2EBEF">
          <td>&nbsp;
            <img src="./images/arrow.gif" alt="JAVA软件工程师：" width="14" height="14">
             <strong>JAVA培训讲师：</strong>
        ...
        <tr bgcolor="#E2EBEF">
          <td>&nbsp;<img src="./images/arrow.gif" alt="JAVA软件工程师：" width="14" height="14" /> <strong>JAVA软件工程师：</strong><span class="style1"><strong class="style1"><img src="./images/hot.gif" width="24" height="14" /></strong></span></td>
        </tr>
        <tr>
          <td><p align="left" class="12"><br />
            职位描述:<br />
        ...
        <tr>
          <td bgcolor="#E2EBEF">&nbsp;<img src="./images/arrow.gif" width="14" height="14" /> <strong>.NET培训讲师</strong></td>
        </tr>
        <tr valign="top">
          <td><p class="12"><br />
            任职要求：<br />
        ...
        <tr>
          <td bgcolor="#E2EBEF">&nbsp;<img src="./images/arrow.gif" width="14" height="14" /> <strong>.NET软件工程师:</strong></td>
        </tr>
        <tr>
          <td><p class="12"><br />
            任职要求:<br />
